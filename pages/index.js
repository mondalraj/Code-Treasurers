  ...
  return (
    <div>
      <div className="bg-info py-2 px-10 flex justify-between items-center">
        ...
        <Link href="/login">
          <button class="btn btn-neutral btn-sm px-4">Login</button>
        </Link>
      </div>
      <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex-col lg:flex-row-reverse">
          <img
            ...
            class="w-1/3 rounded-lg shadow-2xl"
          />
          <div className="pr-48">
            <h1 class="text-5xl text-info font-bold">It's Quiz Time</h1>
      ...
      <section class="bg-neutral body-font">
        <div class="container px-5 py-24 mx-auto">
          <div class="text-center mb-20">
            <h1 class="sm:text-3xl text-3xl font-medium title-font text-info mb-4">
              Why Choose Us?
            </h1>
          ...
          <Link href="/dashboard">
            <button class="flex mx-auto mt-16 btn-info py-2 px-10 rounded text-lg">
              Get Started
            </button>
          </Link>
        </div>
